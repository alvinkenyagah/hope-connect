              ...
              <table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
                <thead className="bg-gray-100">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-sm font-medium text-gray-600">Last Contact</th>
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {assignedVictims.map((victim) => (
                    <tr key={victim._id}>
                      <td className="px-6 py-3 text-sm font-semibold text-gray-800">{victim.name}</td>
                      <td className="px-6 py-3 text-sm text-gray-600">{victim.email}</td>
